...
// This mummy was created by a wraith possessing a Go package and wrapping it for Ghoul use.
...
{{range .Imports}}	"{{.}}"
{{end}}
	_sarcophagus "github.com/archevel/ghoul/sarcophagus"
	_eval "github.com/archevel/ghoul/consume"
	_e "github.com/archevel/ghoul/bones"
)

var _ = _sarcophagus.Unearth
var _ = _fmt.Sprintf

func init() {
	_sarcophagus.Entomb("{{.ShortName}}", "{{.ImportPath}}", &_sarcophagus.Mummy{
...
{{range .Functions}}	_sarcophagus.RegisterIfAllowed(prefix, only, "{{.GhoulName}}", {{.GoFuncName}}, register)
{{end}}
}
...
{{end}}
// RegisterFunctions awakens all the mummified functions in this mummy.
